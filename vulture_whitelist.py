...
registered  # unused variable (app/api/schemas/device.py:25)
...
gas  # unused variable (app/api/schemas/history/bucket_response.py:19)
h2  # unused variable (app/api/schemas/history/bucket_response.py:20)
co  # unused variable (app/api/schemas/history/bucket_response.py:21)
pressure  # unused variable (app/api/schemas/history/bucket_response.py:22)
temp_c  # unused variable (app/api/schemas/history/bucket_response.py:23)
rh  # unused variable (app/api/schemas/history/bucket_response.py:24)
from_  # unused variable (app/api/schemas/history/history_response.py:15)
to  # unused variable (app/api/schemas/history/history_response.py:16)
from_  # unused variable (app/api/schemas/summary/summary_response.py:16)
to  # unused variable (app/api/schemas/summary/summary_response.py:17)
gas  # unused variable (app/api/schemas/summary/summary_response.py:45)
h2  # unused variable (app/api/schemas/summary/summary_response.py:46)
co  # unused variable (app/api/schemas/summary/summary_response.py:47)
pressure  # unused variable (app/api/schemas/summary/summary_response.py:48)
temp_c  # unused variable (app/api/schemas/summary/summary_response.py:49)
rh  # unused variable (app/api/schemas/summary/summary_response.py:50)
model_config  # unused variable (app/core/config.py:17)
FALL  # unused variable (app/simulation/flow.py:13)
# 코덱의 인코더 절반. 서버는 받기만 하므로 제품 경로에 호출부가 없지만,
# 지우면 decode를 왕복으로 검증할 방법이 사라진다 (tests/unit/test_codec_properties.py).
build_frame  # unused function (app/infrastructure/lora/frame.py:41)
model_config  # unused variable (app/simulation/schemas.py:26)
seconds_left  # unused variable (app/simulation/schemas.py:67)
saturated_at  # unused variable (app/simulation/schemas.py:120)
tune_simulator  # unused function (app/simulation/routes.py:58)
...
_.timeout  # unused attribute (app/infrastructure/lora/rylr/serial_at_port.py:17)
...
_.unknown_device  # unused attribute (app/runtime/receiver.py:71)
_.crc_error  # unused attribute (app/runtime/receiver.py:104)
_.parse_error  # unused attribute (app/runtime/receiver.py:106)
...
_.find_device_id  # unused method (app/infrastructure/db/repositories/access_tokens.py:29)
_.process_result_value  # unused method (app/infrastructure/db/types.py:21)
_.touch  # unused method (app/infrastructure/db/repositories/access_tokens.py:34)
...
SqlAlchemyAccessTokenRepository  # unused class (app/infrastructure/db/repositories/access_tokens.py:13)

...
from app.domain.exceptions.device_already_paired import DeviceAlreadyPaired
...
from app.domain.exceptions.device_not_registered import DeviceNotRegistered
